...
import { checkIsCompanyEnabled, getCompany } from '../../scripts/__dropins__/storefront-company-management/api.js';
import {
  CUSTOMER_LOGIN_PATH,
...
export default async function decorate(block) {
  ...
  // Render company profile if authenticated, company functionality is enabled, and customer has a company
